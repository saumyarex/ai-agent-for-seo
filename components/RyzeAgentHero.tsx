  ...
  return (
    <div
      style={{
        ...
        opacity: v ? 1 : 0,
        transform: v ? "none" : "translateX(-10px)",
    ...
    >
      ...
      <span
        style={{
          color: diff > 60 ? "#dc2626" : diff > 40 ? "#d97706" : "#16a34a",
          textAlign: "right",
          fontFamily: "monospace",
        }}
      >
...
const Sparkline = ({
  ...
  const lastPt = ptsArr.at(-1)?.split(",") ?? ["0", "0"];
  return (
          ...
          <div style={{ display: "flex", height: 560 }}>
            ...
            >
                ...
                {[
                  {
                    ...
                    suffix: "",
                    color: "#10b981",
                    spark: [20, 35, 28, 50, 45, 70, 65, 90, 85, 110, 147],
                  },
                  {
                    label: "Ranking Pages",
                    value: 38,
                    suffix: "",
                    color: "#4ade80",
                    spark: [10, 12, 18, 15, 22, 25, 28, 30, 32, 36, 38],
                  },
                  {
                    label: "Avg. Position",
                    value: 14,
                    suffix: ".2",
                    color: "#facc15",
                    spark: [38, 35, 32, 30, 28, 25, 22, 20, 18, 16, 14],
                  },
                  {
                    label: "Est. Traffic",
                    value: 12400,
                    ...
                    color: "#f472b6",
                    spark: [
                      1000, 2000, 1800, 3000, 4500, 5200, 6800, 8000, 9500,
                      11000, 12400,
                    ],
                  },
              ...
              >
                ...
                >
                  {["Keyword Gaps", "AI Insights", "Tech Issues"].map(
                    (t, i) => (
                      <button
                        key={t}
                        className={`tab-btn ${i === 0 ? "tab-active" : "tab-inactive"}`}
                      >
                        {t}
                      </button>
                    ),
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <span style={{ textAlign: "right" }}>OPPTY</span>
                    </div>
                    <div
                    ...
                    >
                      {(() => {
                        const keywordData: [string, string, number, string][] =
                          [
                        ...
                        return keywordData.map(([kw, vol, diff, opp], i) => (
                          <KwRow
                            key={kw}
                            kw={kw}
                            vol={vol}
